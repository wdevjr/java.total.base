...
public class UsuarioDAO {
	...
	public ComboBoxModel carregaComboBox(JComboBox combo) {
		...
		return null; // como � uma fun��o mas que n�o precisa de return carregado pois o while ja faz
						// isso ...
   ...
   // }
	...
	public void remover(String id) {
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "Erro ao excluir Usu�rio do banco de " + "dados " + e.getMessage());
