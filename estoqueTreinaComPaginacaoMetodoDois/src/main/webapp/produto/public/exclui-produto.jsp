...
<body>
	<div class="panel panel-default">
		<div class="panel-heading">
			<strong>Excluir de Produtos</strong>
		</div>
		<div class="panel-body">

			<div class="panel-body">
				<form id="formExcluir" action="exclui-produto" class="form-horizontal"
								...
								<div class="col-md-4">
									...
									<div class="form-group row">
										<label>Nome</label> <input type="text"
											...
											placeholder="Informe o Nome" disabled="disabled"/>
									</div>
								</div>
							</div>
							<div class="form-group row">
								<div class="col-md-4">
									<div class="form-group row">
										<label>Preço Custo</label> <input type="text"
											...
											placeholder="Informe o Preço Custo!" disabled="disabled" />
									</div>
								</div>
							</div>
							<div class="form-group row">
								<div class="col-md-4">
									<div class="form-group row">
										<label>Quantidade</label> <input type="text"
											...
											placeholder="Informe a quantidade!"  disabled="disabled"/>
									</div>
								</div>
							</div>
						</fieldset>
