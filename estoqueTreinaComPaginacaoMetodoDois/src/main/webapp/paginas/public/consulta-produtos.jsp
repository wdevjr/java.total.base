...
<link rel="stylesheet" href="../../Styles/yui-datatable/yui-datatable.css">
		...
		<div class="panel-body">
			...
			<c:if test="${empty produtos}">
				...
				<div class="table-responsive">
							...
							<tr>
								...
								<div class="btn-group pull-right">
									<td style="text-align: center;"><a
										href="<c:url value="edita-produto?id=${produto.id}" />"><img src="../../img/edit.png"></a></td>
									<td style="text-align: center;"><a
										href="<c:url value="exclui-produto?id=${produto.id}"/>"><img src="../../img/delete.png"></a></td>
					...
					<c:forEach items="${paginacao}" var="produto" varStatus="q">
						<td><a
							href="<c:url value="/paginas/public/consulta-produtos?page=${q.count}"/>">${q.count}</a></td>
					</c:forEach>
			</div>
			<p>
			...
			<div class="panel-footer">
				<a class="btn btn-sm btn-success"
					href=<c:url value="/paginas/public/cadastro-produto.jsp"/>>Novo</a>
			</div>
			<c:import url="/paginas/public/rodape.jsp" />
		</div>
	</div>
</body>
</html>