...
import com.algaworks.warhjr.estoque.repository.dao.InterfaceProdutosDAO;
import com.algaworks.warhjr.estoque.util.JpaUtil;

@WebServlet("/paginas/public/consulta-produtos")
public class ConsultaProdutosServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) {
		...
		if ((nometemp != null) && (nometemp != "")) {
			...
			RequestDispatcher dispatcher2 = request.getRequestDispatcher("/paginas/public/consulta-produtos.jsp");
			try {
			...
			request.setAttribute("agora", new Date());
			cont = "0";
			RequestDispatcher dispatcher1 = request.getRequestDispatcher("/paginas/public/consulta-produtos.jsp");
			try {
