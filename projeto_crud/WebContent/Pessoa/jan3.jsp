...
<script>
function envia() {
	opener.document.f8.idCidade.value = document.f2.CodCidade.value;
	opener.document.f8.nomeCidade.value = document.f2.nomeCidad.value;
	opener.document.f8.uf.value = document.f2.nomeUFd.value;
	...
	<h:form>
		...
		<h:messages/>
		 ...
		 <fieldset>
			...
			<h:dataTable value="#{CidadeManagedBean.lista}" rows="3" var="item" styleClass="tablecloth-theme" headerClass="header" rowClasses="row1,row2" width="55%"  style=" width : 736px;">	
				<h:column>
					<f:facet name="header">
        ...
        <fieldset> <legend>Conferimento dos Dados</legend>
