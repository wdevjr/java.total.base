...
public class LoginBean implements Serializable {
	...
	public void fazerLogin() {
       // String senha = Util.converterStringEmMD5(this.login.getSenha());
        String hql = "SELECT vo FROM Usuario vo"
                ...
                + " AND vo.senha='" +this.login.getSenha()+ "'";
       Usuario verifica = new UsuarioControlador().carregar(hql);
      // Nivel nivel = null;
       //verifica.setUsuario("warhjr");
      // verifica.setSenha("senhah");
       //verifica.setNivel(nivel);
    ...
    private void enviarEmail(Usuario usuario) {
        ...
        Session session = Session.getDefaultInstance(props,
                new javax.mail.Authenticator() {
                    ...
                    protected PasswordAuthentication getPasswordAuthentication() {
                        return new PasswordAuthentication("warhjr@gmail.com", "senha");
                    }
                });
        ...
        try {
            ...
            message.setFrom(new InternetAddress("warhjr@gmail.com")); //Remetente
