...
public class ArquivoController 
{
	...
	public void SalvarArq(Arquivo arquivo, String file) {
		
		ArquivoDAO auxDao = new ArquivoDAO();
		
		if (file.isEmpty()) {
		//throw new Exception("Insira um Arquivo!");
		JOptionPane.showMessageDialog(null, "Arquivo, vazio ! Insira uma Arquivo!","Arquivos!",JOptionPane.WARNING_MESSAGE);
		return;
		}
	    ...
	    JOptionPane.showMessageDialog(null, "Pessoa Não Informada, Insira uma Pessoa!","Arquivos!",JOptionPane.WARNING_MESSAGE);	
	    return;
	   }
